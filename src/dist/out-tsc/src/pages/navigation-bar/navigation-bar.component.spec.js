...
describe('NavigationBarComponent', function () {
    ...
    beforeEach(testing_1.async(function () {
        testing_1.TestBed.configureTestingModule({
            declarations: [navigation_bar_component_1.NavigationBarComponent]
        })
            .compileComponents();
    }));
    beforeEach(function () {
        fixture = testing_1.TestBed.createComponent(navigation_bar_component_1.NavigationBarComponent);
